//Sentinel Linear algorithem

//Search as the name suggests is a type of Linear Search where the number of 
//comparisons is reduced as compared to a traditional linear search.
